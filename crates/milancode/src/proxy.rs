...
mod tests {
        ...
        assert_eq!(
            ...
            vec![
                ...
                ProxySegment::ToolUse {
                    id: "proxy-tool-3".to_string(),
                    name: "read_file".to_string(),
                    input: json!({"path":"crates/milancode/src/main.rs"}).to_string(),
                },
            ]
        );
    }
            ...
            vec![
                ProxySegment::ToolUse {
                    ...
                    input: json!({
                        "limit": 50,
                        "offset": 80,
                        "path": "crates/milancode/src/main.rs"
                    })
                    .to_string(),
                },
                ProxySegment::ToolUse {
    ...
    fn ignores_orphan_arg_closers_inside_tool_call_body() {
        let text = "<tool_call name=\"write_file\">\n  <arg name=\"path\">milancode-project-summary.md</arg>\n  <arg name=\"content\">hello</arg>\n</arg>\n</tool_call>";
        let segments = parse_proxy_response(text, &specs()).expect("proxy response should parse");
        assert_eq!(
            segments,
            vec![ProxySegment::ToolUse {
                ...
                name: "write_file".to_string(),
                input: json!({
                    "path": "milancode-project-summary.md",
                    "content": "hello"
                })
                .to_string(),
            }]
